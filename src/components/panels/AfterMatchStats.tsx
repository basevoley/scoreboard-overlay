...
interface AfterMatchStatsProps {
  matchDetails: MatchDetails;
  matchData: MatchData;
  afterMatchConfig: AfterMatchConfig;
}

const AfterMatchStats = ({ matchDetails, matchData, afterMatchConfig }: AfterMatchStatsProps) => {
                ...
                {STATS.map((stat, index) => (
                  <tr key={index} className={styles['stat-row']}>
                    ...
                    <td className={styles['stat-label']}>
                      <div className={styles['stat-content']}>{stat.label}</div>
                    </td>
                    <td className={styles['stat-value']}>
                      <div className={styles['stat-content']}>
