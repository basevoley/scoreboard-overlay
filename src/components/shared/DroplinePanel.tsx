...
const DroplinePanel = ({ icon, textLine1, textLine2, isTopPosition, isAnimatedIn }: DroplinePanelProps) => {
  if (!textLine1 && !textLine2) return null;
